...
#ifdef WITH_DEVICE_WS2812_STRIP
    if(strcmp(output_device_name, "ws2812-strip") == 0){
        fprintf(stderr, "Using device: ws2812-strip\n");
        output_device = ws2812_strip(16); //#TODO numero di led da configurazione
        return 0;
    }
#endif
